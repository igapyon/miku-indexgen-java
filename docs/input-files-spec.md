...
The upstream Node.js runtime remains the source of truth. This Java companion
repository keeps a copy of this product-specific contract so Java runtime
behavior can be checked against the upstream `miku-indexgen` behavior.
