...
final class HelpText {
    static final String TEXT = "Usage:\n"
            ...
            + "  miku-indexgen --input-parent-directory <dir> [--output-directory <dir>] [--title \"Docs Index\"] [--markdown] [--no-generator] [--json-summary-path /title,/name] [--no-recursive] [--no-overwrite] [--include-ext md,json] [--input-encoding utf8] [--output-encoding utf8] [--verbose]\n"
            ...
            + "  - front matter is parsed as documented YAML metadata\n"
            ...
            + "  --no-recursive                 Scan only immediate files in each input base.\n"
            ...
            + "  --verbose                      Print progress and timing details to stderr.\n"
